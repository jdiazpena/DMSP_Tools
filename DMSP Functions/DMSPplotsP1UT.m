function DMSPplotsP1UT(InitialTime,FinalTime,data,ticks,mltvar)
...
figure;
s1=subplot(4,1,1);
set(s1, 'Position', get(s1,'Position')-[0.025 0 -0.03 -0.055]);
...
legend('Te','Location','northwest','Orientation','horizontal');
...
if mltvar==0
    txtHandle = text(-0.045, -0.21, 'Lat','Units','normalized','FontSize',fontsize);
    set(txtHandle, 'HorizontalAlignment','right','VerticalAlignment','middle');
    txtHandle = text(-0.045, -0.35, 'Lon','Units','normalized','FontSize',fontsize);
    set(txtHandle, 'HorizontalAlignment','right','VerticalAlignment','middle');
else
    txtHandle = text(-0.045, -0.21, 'MLat','Units','normalized','FontSize',fontsize);
    set(txtHandle, 'HorizontalAlignment','right','VerticalAlignment','middle');
    txtHandle = text(-0.045, -0.35, 'MLT','Units','normalized','FontSize',fontsize);
    set(txtHandle, 'HorizontalAlignment','right','VerticalAlignment','middle');
end
...
set(ax4,'Units','normalized','fontsize',fontsize);


baxis2=get(s4,'Position');
