function DMSPmvplotUTD(latplot,lonplot,type,data,mltvar, linestep, ttick,indexesplot,scale,startHL,endHL,mnorthlat,mnorthlon,obctimes)
...
for w=1:size(newindexes,2)
    DMSPorbitplot(lat,lon,timeut,timemlt,vh,type,newindexes(1,w):newindexes(2,w),scale,linestep,indexesHL,mnorthlat,mnorthlon,...
